...
: AbstractStage("LogoStage", resourceManager, relDataPath)
, m_viewportComponent(*this)
, m_virtualTimeComponent(*this)
, m_animation(true)
, m_background(0, 0, 0, 255)
, m_textureFilename(m_relDataPath + "data/logo/gloperate-logo.png")
, m_angle(0.0f)
{
    // Always process if animation is on
    setAlwaysProcess(m_animation);
